...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260123223704_AddStaffAndWorkingHours")]
    partial class AddStaffAndWorkingHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Schedule", b =>
                {
                    ...
                    b.ToTable("schedules", null, t =>
                        {
                            t.HasCheckConstraint("ck_schedules_dayofweek_range", "\"day_of_week\" >= 0 AND \"day_of_week\" <= 6");

                            t.HasCheckConstraint("ck_schedules_time_range", "\"is_day_off\" = true OR \"end_time\" > \"start_time\"");
                        });
                });
            ...
            modelBuilder.Entity("staff_service", b =>
                {
                    ...
                    b.HasKey("staff_id", "service_id");

                    b.HasIndex("service_id")
                        .HasDatabaseName("ix_staff_service_service_id");

                    b.ToTable("staff_service", (string)null);
                });
